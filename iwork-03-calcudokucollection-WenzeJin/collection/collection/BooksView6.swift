...
class BooksView6: UITableViewController, WKUIDelegate{
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        if(self.vol == 1){
            myURL=URL(string: String(format: "https://krazydad.com/inkies/sfiles/INKY_6%@_b%@_4pp.pdf", difficulty, numberFormatter.string(from: num)!))
            print(String(format: "https://krazydad.com/inkies/sfiles/INKY_6%@_b%@_4pp.pdf", difficulty, numberFormatter.string(from: num)!))
        } else {
            myURL=URL(string: String(format: "https://krazydad.com/inkies/sfiles/INKY_v%d_6%@_b%@_4pp.pdf", self.vol, difficulty, numberFormatter.string(from: num)!))
        }
...
class VolsView6: UITableViewController{
...
class DiffsView6: UITableViewController{
