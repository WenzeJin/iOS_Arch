...
class BooksView5: UITableViewController, WKUIDelegate{
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        if(self.vol == 1){
            myURL=URL(string: String(format: "https://krazydad.com/inkies/sfiles/INKY_5%@_b%@_4pp.pdf", difficulty, numberFormatter.string(from: num)!))
            print(String(format: "https://krazydad.com/inkies/sfiles/INKY_5%@_b%@_4pp.pdf", difficulty, numberFormatter.string(from: num)!))
        } else {
            myURL=URL(string: String(format: "https://krazydad.com/inkies/sfiles/INKY_v%d_5%@_b%@_4pp.pdf", self.vol, difficulty, numberFormatter.string(from: num)!))
        }
...
class VolsView5: UITableViewController{
...
class DiffsView5: UITableViewController{
